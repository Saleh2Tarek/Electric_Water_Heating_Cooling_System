...
#ifndef APP_SYSTEM_SYSTEM_INTERFACE_H_
#define APP_SYSTEM_SYSTEM_INTERFACE_H_
...
/*
	...
	Function Returns     : ENUM
	Function Arguments   : ARRAY ADDRESS {* Copy_pAstrTempReadings}, A NEW READ TEMPERATURE {Copy_u16_tTempNewValue}
	Function Description : Internal function of the [SYSTEM_enuOnState(),
	 	 	 	 	 	   which is responsible for  entering a temperature reading in a ten size array.
 */
/*-----------------------------------------------------------------------------------------------*/

ES_t SYSTEM_enuAddNewTemp(u16_t * Copy_pAstrTempReadings , u16_t Copy_u16_tTempNewValue);
...
/*
	...
	Function Returns     : ENUM
	Function Arguments   : ARRAY ADDRESS {* Copy_pAstrTempReadings}, A VARIABLE ADDRESS TO HOLD THE COLCULATED TEMPERATURE READINGS AVERAGE {* Copy_u16_tReturnTempValue}
	Function Description : Internal function of the [SYSTEM_enuOnState(),
	 	 	 	 	 	   which is responsible for  calculating the average of the last ten read temperature reading in the last one second.
 */
/*-----------------------------------------------------------------------------------------------*/

ES_t SYSTEM_enuCalculateAverateTemp(u16_t * Copy_pAstrTempReadings, u16_t * Copy_u16_tReturnTempValue);
...
#endif /* APP_SYSTEM_SYSTEM_INTERFACE_H_ */
