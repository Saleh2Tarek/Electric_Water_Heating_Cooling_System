...
#define TIMER0_u32_tNUMBER_OF_OVERFLOW					(u32_t)(TIMER0_DESIRED_TIME / TIMER0_OVERFLOW)
#define TIMER0_FRECTION									((u8_t) TIMER0_u32_tNUMBER_OF_OVERFLOW) - TIMER0_u32_tNUMBER_OF_OVERFLOW
#define TIMER0_u32_tNUMBER_OF_TICKS_FRECTION   			TIMER0_FRECTION * TIMER0_RESOLUTION_COUNTS
#define TIMER0_u8_tPRELOAD_VALUE						(u8_t)( TIMER0_RESOLUTION_COUNTS - TIMER0_u32_tNUMBER_OF_TICKS_FRECTION )
...
#define TIMER1_DESIRED_TIME								(f32_t)	100/1000
...
#define TIMER1_u32_tNUMBER_OF_OVERFLOW					(f32_t)(TIMER1_DESIRED_TIME / TIMER1_OVERFLOW)
#define TIMER1_FRECTION									((u8_t) TIMER1_u32_tNUMBER_OF_OVERFLOW) - TIMER1_u32_tNUMBER_OF_OVERFLOW
#define TIMER1_u32_tNUMBER_OF_TICKS_FRECTION   			(u16_t) (TIMER1_FRECTION * TIMER1_RESOLUTION_COUNTS)
#define TIMER1_u16_tPRELOAD_VALUE						(u16_t)( TIMER1_RESOLUTION_COUNTS - TIMER1_u32_tNUMBER_OF_TICKS_FRECTION )
...
#define TIMER2_u32_tNUMBER_OF_OVERFLOW					(u32_t)(TIMER2_DESIRED_TIME / TIMER2_OVERFLOW)
#define TIMER2_FRECTION									((u8_t) TIMER2_u32_tNUMBER_OF_OVERFLOW) - TIMER2_u32_tNUMBER_OF_OVERFLOW
#define TIMER2_u32_tNUMBER_OF_TICKS_FRECTION   			TIMER2_FRECTION * TIMER2_RESOLUTION_COUNTS
#define TIMER2_u8_tPRELOAD_VALUE						(u8_t)( TIMER2_RESOLUTION_COUNTS - TIMER2_u32_tNUMBER_OF_TICKS_FRECTION )
