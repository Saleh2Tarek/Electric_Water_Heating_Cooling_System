...
extern u16_t Global_u16_tTimer0CTC_OneSecondCounter=0;
extern u32_t Global_32_tTIMER1_CTCA_SecondsCounter=0;
static u32_t Global_u32_tCounterOVF =0;
static u32_t Global_u32_tCounterCTC =0;
static u16_t Global_u32_tCounterCTC1A=0;
static u16_t Global_u32_tCounterCTC1B=0;

static u32_t Global_u32_tCounterOVF1 =0;

static u32_t Global_u32_tCounterOVF2 =0;
static u16_t Global_u32_tCounterCTC2=0;

static  u16_t TIMER0_u16_tDELAY_MILEOSECOND;
static  u16_t TIMER1_u16_tDELAY_MILEOSECOND;
static  u16_t TIMER2_u16_tDELAY_MILEOSECOND;

static 	u16_t Global_u16_TIMER1_PreloadValue = TIMER1_u16_tPRELOAD_VALUE;
...
/*-----------------------------  Compare Match Output Mode --------------------------*/
	  		 	 	 ...
	  		 	 	 TCNT0 = TIMER0_u8_tPRELOAD_VALUE;
...
/*-----------------------------  Compare Match Output Mode --------------------------*/
	  		 	 	 ...
	  		 	 	 TCNT2 = TIMER2_u8_tPRELOAD_VALUE;
/*-----------------------------  Overflow Interrupt Enable --------------------------*/
...
/*----------------------------- TIMER2_CTC_MODE --------------------------*/
	  		 	 	  	 	...
	  		 	 	  	 	ASSR &=~ (TIMER_MASK_BIT <<ASSR_AS2);
	  		 	 	  	 	 	 //OCR0 =TIMER_OCR0_COUNTS_NUMBER;
	  		 	 	  	 	 	 OCR2= 250;
	  		 	 	  	 	 	 //OCR2 =TIMER2_u32_tNUMBER_OF_TICKS_FRECTION;
...
ISR (VECT_TIMER2_CTC)
{
	...
	{
	Global_u32_tCounterCTC2 ++;

		if (Global_u32_tCounterCTC2 == TIMER2_u16_tDELAY_MILEOSECOND)

		{
			TIMER2_pfunISRFun[TIMER_CTC2_INTERRUPT_INDEX]();

			Global_u32_tCounterCTC2 =0;
		}
	}
...
{
	ES_t Local_enuErrorState = ES_NOK;
	u16_t Local_u16OutCompareValue_A,Local_u16OutCompareValue_B;
